...
function p(n, t) {
  ...
  if (e.addEventListener("load", o), window.dataLayer = window.dataLayer ?? [], (_a = window.dataLayer) == null ? void 0 : _a.push({ event: "gtm.js", "gtm.start": (/* @__PURE__ */ new Date()).getTime() }), !n) return e;
  ...
  if (typeof (a == null ? void 0 : a.appendChild) != "function") throw new Error("parentElement must be a DOM element");
...
var y = class {
  constructor(t) {
    ...
    if (Array.isArray(t.id)) for (let r of t.id) typeof r == "string" ? s(r) : s(r.id);
    else s(t.id);
  ...
  enable(t = true, r) {
    if (this.options.enabled = t, this.isInBrowserContext() && t && !m(r) && this.options.loadScript) if (Array.isArray(this.id)) this.id.forEach((e) => {
      let o;
...
function G(a, t, r = [], n, f = () => ({})) {
  ...
  t.afterEach(async (e, u, p2) => {
    var _a, _b, _c;
    if (typeof e.name != "string" || Array.isArray(r) && r.includes(e.name) || typeof r == "function" && r(e, u)) return;
