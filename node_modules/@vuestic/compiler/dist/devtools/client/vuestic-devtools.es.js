...
import { onMounted, onBeforeUnmount, watch, defineComponent, ref, watchEffect, toRef, openBlock, createElementBlock, normalizeStyle, unref, createCommentVNode, computed, Fragment, isVNode, mergeModels, useModel, createBlock, withCtx, createElementVNode, createTextVNode, toDisplayString, createVNode, renderList, getCurrentInstance, toHandlerKey, withDirectives, vModelText, resolveComponent, pushScopeId, popScopeId, reactive, renderSlot, normalizeClass, withModifiers, onBeforeMount, nextTick, Teleport, mergeProps, toHandlers, createApp } from "vue";
import { useColors, VaSelect, VaColorIndicator, VaInput, VaCheckbox, VaCounter, VaButton, VaIcon, VaDivider, VaTextarea, VaButtonToggle, VaSpacer, VaTabs, VaTab, VaDropdown, VaDropdownContent, useToast, VaCard, VaScrollContainer, createVuestic } from "vuestic-ui";
...
const Outline = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["__scopeId", "data-v-e435855f"]]);
const _sfc_main$t = {};
const _hoisted_1$i = { class: "va-devtools-overlay" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$i);
}
const Overlay = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render], ["__scopeId", "data-v-1a4b2b08"]]);
...
const Color = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-32b4dcc4"]]);
...
const _hoisted_3$9 = { class: "checkbox-option__box" };
...
const NumberInput = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-f94fa3ea"]]);
const _hoisted_1$e = { class: "not-avaliable-option" };
const _hoisted_2$8 = { class: "va-label" };
const _hoisted_3$8 = /* @__PURE__ */ createElementVNode("div", { class: "not-avaliable-option__box" }, " Not avaliable ", -1);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$e, [
        createElementVNode("div", _hoisted_2$8, toDisplayString(props.label), 1),
        _hoisted_3$8
      ]);
    };
  }
...
const _hoisted_2$7 = { key: 7 };
const _hoisted_3$7 = { class: "va-label" };
const _hoisted_4$3 = /* @__PURE__ */ createElementVNode("div", { style: { "height": "36px", "line-height": "36px" } }, " This prop can be edited only in Source Code tab for now. ", -1);
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(propsConfigs.value, (prop) => {
          return openBlock(), createElementBlock(Fragment, null, [
            prop.type === "color" ? (openBlock(), createBlock(Color, {
              ...
              createElementVNode("div", _hoisted_3$7, toDisplayString(prop.name), 1),
              _hoisted_4$3
            ]))
          ], 64);
        }), 256))
...
const ComponentSlots = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-406ffc41"]]);
const getWasmInlined = async (info) => {
  return import("./wasm.js").then((wasm) => wasm.default(info));
};
var FontStyle;
(function(FontStyle2) {
...
const _BasicScopeAttributesProvider = class _BasicScopeAttributesProvider {
...
let BasicScopeAttributesProvider = _BasicScopeAttributesProvider;
class ScopeMatcher {
  constructor(values) {
...
const _StateStackImpl = class _StateStackImpl {
  /**
   * Invariant:
   * ```
...
let StateStackImpl = _StateStackImpl;
...
const bundledLanguagesInfo = [
  {
    "id": "angular-html",
    "name": "Angular HTML",
    "import": () => import("./angular-html.js").then((n) => n.e)
  },
  {
    "id": "angular-ts",
...
const useHasListener = (eventName) => {
  var _a;
  const vm = getCurrentInstance();
  const props = (_a = vm.vnode) == null ? void 0 : _a.props;
  return props && toHandlerKey(eventName) in props;
};
const _hoisted_1$b = { class: "code-preview-wrapper" };
const _hoisted_2$6 = { class: "code-preview" };
...
const _hoisted_1$a = { class: "va-devtools-source-code" };
const _hoisted_2$5 = { class: "va-devtools-source-code__toolbar" };
const _hoisted_3$5 = { class: "va-devtools-source-code__file-name" };
const _hoisted_4$2 = { class: "va-devtools-source-code__code" };
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createElementVNode("div", _hoisted_1$a, [
          createElementVNode("div", _hoisted_2$5, [
            createElementVNode("div", _hoisted_3$5, toDisplayString(unref(source).fileName), 1),
...
const ComponentSource = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-b5b804cb"]]);
...
const _hoisted_1$9 = { class: "va-devtools-flex-editor" };
...
const FlexEditor = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-87ddd91c"]]);
const _withScopeId$2 = (n) => (pushScopeId("data-v-dbda30fa"), n = n(), popScopeId(), n);
const _hoisted_1$8 = {
  key: 0,
  class: "va-devtools-layout-editor--no-flex-container"
};
const _hoisted_2$4 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createElementVNode("p", null, "Layout settings are only available for flex containers for now.", -1));
...
const LayoutEditor = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-dbda30fa"]]);
const _hoisted_1$7 = /* @__PURE__ */ createElementVNode("p", { class: "va-title mb-2" }, "Flex layout", -1);
...
const _hoisted_1$6 = { class: "c-component-view" };
const _hoisted_2$3 = { class: "c-component-view__toolbar" };
const _hoisted_3$3 = { key: 0 };
const _hoisted_4$1 = { class: "c-component-view__content" };
const _hoisted_5$1 = { class: "c-component-view__tabs-content" };
...
const ComponentView = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-68d86a66"]]);
const useWindowSize = () => {
...
const _hoisted_1$5 = { class: "draggable-window-content" };
const PADDING = 8;
...
const AppTreeItemComponent = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-81da84db"]]);
const _hoisted_1$3 = {
  key: 0,
...
const _hoisted_3$1 = { class: "va-devtools-app-tree__items" };
...
const AppTree = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-c3d9e271"]]);
...
const ComponentSelectItem = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-e5e09e9d"]]);
const code$6 = `
<VaButton>
  Button
</VaButton>
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-00ae6796"), n = n(), popScopeId(), n);
const _hoisted_1$2 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createElementVNode("div", { class: "div" }, null, -1));
const code = `
<div>
...
const BasicDiv = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-00ae6796"]]);
const _withScopeId = (n) => (pushScopeId("data-v-52a5d047"), n = n(), popScopeId(), n);
const _hoisted_1$1 = { class: "va-devtools-component-select" };
const _hoisted_2 = { class: "va-devtools-component-select__components" };
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("h2", null, "Basic", -1));
const _hoisted_4 = { class: "va-devtools-component-select__components-list" };
const _hoisted_5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("h2", null, "Buttons", -1));
const _hoisted_6 = { class: "va-devtools-component-select__components-list" };
const _hoisted_7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("h2", null, "Inputs", -1));
const _hoisted_8 = { class: "va-devtools-component-select__components-list" };
...
const ComponentSelect = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-52a5d047"]]);
...
const _hoisted_1 = { class: "va-devtools-toolbar" };
...
const createVuesticDevtools = () => ({
  install(app) {
    const appRoot = document.createElement("div");
    appRoot.id = "vuestic-devtools";
    document.body.appendChild(appRoot);
    createApp(_sfc_main).use(createVuestic({
      config: {
        colors: {
          variables: {
